...
class HomeController extends Controller
{
    ...
    public function siteInfoUpdate(Request $request, $type){
        ...
        $request->validate([
            ...
            'address_1' => 'required',
            'warehouse_1' => 'nullable|max:200',
            'warehouse_2' => 'nullable|max:200',
