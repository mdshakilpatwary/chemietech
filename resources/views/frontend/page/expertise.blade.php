...
{{--
    @if($key % 3 == 0)
        ...
        <section id="our_expertise_info">
            <div class="row">
                <div class="col-md-6 col-xl-6 col-lg-6 col-12-col-sm-12 expertise_item_flex">
    ...
    @if($key % 2 == 0 )
        ...
        @else
            ...
            <section id="our_expertise_info" class="our_expertise_info-3" style="background:#323E48;">
                <div class="row">
                    <div class="col-md-6 col-xl-6 col-lg-6 col-12 col-sm-12 expertise_item_flex">
                        <div class="our_expertise_info_content " >
    ...
    @else
        ...
        <section id="our_expertise_info-2">
            <div class="row">
                ...
                <div class="col-md-6 col-xl-6 col-lg-6 col-12 col-sm-12 expertise_item_flex_2">
                    <div class="our_expertise_info_content-2">
                        <h3>{{$expertise->title}}</h3>
                        <ul style="list-style: none; padding: 0;">
                            <li>{!!$expertise->text_content!!}</li>  
