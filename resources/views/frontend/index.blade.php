  ...
  @endif
      ...
      <!---->
       @if(PageElement::where('type','=',1)->first())
          ...
          @endphp
      <section id="feature" class="section-padding wow fadeIn delay-05s" style="background-image: url({{ asset('uploads/element/' . $elements->image) }}); background-size: cover; background-position: center center; background-repeat: no-repeat;">
        <div class="container">
          <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12 col-12">
              <h4 class="industrial-content-heading">{{$elements->title}}</h4>
            </div>
          </div>
