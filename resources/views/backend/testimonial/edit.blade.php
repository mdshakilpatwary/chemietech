                  ...
                  <div class="row mb-3">
                      ...
                      <div class="offset-md-2 offset-lg-2 col-md-8 col-lg-8 col-12 col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="name" class="form-control" id="" value="{{$testimonial->name}}">
                            @error('name')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="title" class="form-control" id="" value="{{$testimonial->title}}">
                            @error('title')
                            <p class="text-danger">{{$message}}</p>                
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <img src="{{asset($testimonial->image)}}" alt="" style="width: 200px; height:150px; margin-top:5px;">
                            @error('image')
                            <p class="text-danger">{{$message}}</p> 
                            @enderror
                        </div>
                        <div class="form-group mb-3">
                          ...
                          <textarea name="description" class="form-control" id="" cols="3" rows="5">{{$testimonial->description}}</textarea>
                          @error('description')
                          <p class="text-danger">{{$message}}</p>                
                          @enderror
                      </div>
