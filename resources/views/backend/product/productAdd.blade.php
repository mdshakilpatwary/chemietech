                       ...
                       <div class="row">
                        ...
                        <div class="col-md-6 col-xl-6 col-lg-6 col-12 col-sm-12">
                          <div class="form-group mb-3">
                            ...
                            <div class="invalid-feedback">Please Select product Sub Category</div>
                            @error('subcategory')
                            <p class="text-danger">{{$message}}</p>                
                            @enderror
                          </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" cols="5" rows="5" name="description"  id="" required>{{old('description')}}</textarea>                            
