    ...
    <div class="row">
        <div class="offset-md-1 offset-lg-1 col-lg-10 col-12 col-md-10">
            ...
            <div class="card">
              ...
              @php
                $csr_raw=CsrPageElement::where('type','=', 4)->first();
                $title = json_decode($csr_raw->title, true) ;
                $content = json_decode($csr_raw->text_content, true) ;
                
              @endphp
              <div class="card-body">
                <h5 class="card-title">Csr Production Update</h5>
  
                <!-- General Form Elements -->
                <form method="POST" action="{{route('csr.production.update',$csr_raw->id)}}" enctype="multipart/form-data">
                @csrf
                  <div class="row mb-3">
                      
                      <div class="offset-md-2 offset-lg-2 col-md-8 col-lg-8 col-12 col-sm-12"> 
                            <div class="form-group mb-3">
                                    <label for="inputText" class="col-form-label">Section Title</label>
                                    <input type="text" class="form-control" name="section_title" value="{{$csr_raw->section_title}}">
                                    @error('section_title')
              ...
              @else
              <div class="card-body">
                <h5 class="card-title">Csr Production Add</h5>
  
                <!-- General Form Elements -->
                <form method="POST" action="{{route('csr.production.store')}}" enctype="multipart/form-data">
                @csrf
                  <div class="row mb-3">
                      ...
                      <div class="col-md-12 col-lg-12 col-12 col-sm-12">   
                             <div class="form-group mb-3">
                                    <label for="inputText" class="col-form-label">Title</label>
                                    <input type="text" class="form-control" name="section_title" value="{{old('section_title')}}">
                                    @error('section_title')
                                    <p class="text-danger">{{$message}}</p> 
                                    @enderror
                             </div>
