  ...
  <section class="section profile">
    <div class="row">
        <div class="offset-md-1 offset-lg-1 col-lg-10 col-12 col-md-10">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Membership Info Add</h5>
  

                  <!-- insert Form Elements -->
                        <form method="POST" action="{{route('about.membership.update',$membership->id)}}" enctype="multipart/form-data" class="needs-validation" novalidate="">
                        @csrf
                            <div class="row mb-3">
                            ...
                            <div class="offset-md-2 offset-lg-2 col-md-8 col-lg-8 col-12 col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xl-12 col-lg12 col-12 col-sm-12">
                                        ...
                                        <input type="text" name="title" id="" class="form-control" value="{{$membership->title}}" required>
                                             @error('title')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <img src="{{asset($membership->image)}}" alt="" class="change_image mb-2" style="width: 150px; height: 100px; display:block;">
