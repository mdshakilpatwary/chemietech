              ...
              <div class="card-body">
                <h5 class="card-title">Certification Info Add</h5>
                  ...
                  <!-- insert Form Elements -->
                        <form method="POST" action="{{route('about.certification.store')}}" enctype="multipart/form-data" class="needs-validation" novalidate="">
                        @csrf
                            <div class="row mb-3">
                            ...
                            <div class="offset-md-2 offset-lg-2 col-md-8 col-lg-8 col-12 col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xl-12 col-lg12 col-12 col-sm-12">
                                      ...
                                      <input type="text" name="subtitle" id="" class="form-control" value="{{old('subtitle')}}">
                                            @error('subtitle')
                                              <p class="text-danger">{{$message}}</p>
                                          @enderror
                                      </div>
