                          ...
                          <div class="offset-md-1 offset-lg-1 col-md-10 col-lg-10 col-12 col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xl-12 col-lg-12 col-12 col-sm-12">
                                    ...
                                    <input type="text" name="title" id="" class="form-control" value="{{$elements->title}}">
                                    </div>
                                    <div class="form-group pb-3">
                                        <label for="">Background image <span style="color: #6b6868">(resolution 1600x900 )</span></label>
                                        <input type="file" name="bg_image" id="" class="form-control">
                                        <img src="{{ asset('uploads/element/' . $elements->image) }}" alt="" width="100">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xl-12 col-lg-12 col-12 col-sm-12">
                                        ...
                                        <div class="form-group pb-3">
                                            ...
                                            <input type="file" name="bg_image" id="" class="form-control mt-1">
                                            @error('bg_image')
                                                <p class="text-danger">{{$message}}</p>
                                            @enderror
                                        ...
                                        <table class="table" id="elementTable">
                                            <tr class="row_one">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <label for="elementImage">Image <span style="color: #6b6868">(resolution 1600x900 )</span></label>
