...
<div class="pagetitle">
    <h1>Home Contact Element</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
        <li class="breadcrumb-item active">Home Contact Element</li>
      </ol>
    </nav>
  </div>
  <!-- End Page Title -->
  ...
  <section class="section profile">
    <div class="row">
        <div class="offset-md-1 offset-lg-1 col-lg-10 col-12 col-md-10">
            ...
            <div class="card">
            @if(HomePageElement::where('type',3)->count() > 0)
            @php
            $contact = HomePageElement::where('type',3)->first();
            @endphp
              <div class="card-body">
                <h5 class="card-title">Home Contact Element Update</h5>
  
                <!-- General Form Elements -->
                <form method="POST" action="{{route('home.contact.element.update',$contact->type)}}" enctype="multipart/form-data" class="needs-validation" novalidate="">
                @csrf
                  <div class="row mb-3">
                      ...
                      <div class="offset-md-1 offset-lg-1 col-md-10 col-lg-10 col-12 col-sm-12">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="title" value="{{$contact->title}}" required>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="description" class="form-control" id="" cols="3" rows="5" required>{{$contact->title}}</textarea>
                            @error('description')
                            <p class="text-danger">{{$message}}</p>                
                            @enderror
                          </div>
                          ...
                          <div class="form-group mb-3">
                            ...
                            <img src="{{asset($contact->image)}}" alt="" class="p_change_image mb-2" style="width: 150px; height: 100px; display:block;">
...
<!-- update part  -->
            @else
            <div class="card-body">
                <h5 class="card-title">Home Contact Element Add</h5>
  
                <!-- General Form Elements -->
                <form method="POST" action="{{route('home.contact.element.store')}}" enctype="multipart/form-data" class="needs-validation" novalidate="">
                @csrf
                  <div class="row mb-3">
                      ...
                      <div class="offset-md-1 offset-lg-1 col-md-10 col-lg-10 col-12 col-sm-12">
                        ...
                        <div class="form-group mb-3">
                            <label class="col-form-label"> Short Description</label>
                            <textarea name="description" class="form-control" id="" cols="3" rows="5" required>{{old('description')}}</textarea>
                            @error('description')
                            <p class="text-danger">{{$message}}</p>                
                            @enderror
                          </div>
